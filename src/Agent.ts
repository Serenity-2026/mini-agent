...
export default class Agent {
    ...
    constructor(mcpClients: MCPClient[], systemPrompt: string = '', context: string = '') {
    ...
    async init() {
        ...
        this.llm = new ChatOpenAI( this.systemPrompt, tools, this.context);
    }
    ...
    async invoke(prompt: string) {
        if (!this.llm) throw new Error('Agent not initialized！please use init method first');
